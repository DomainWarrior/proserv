...
export function Footer() {
  return (
    <footer className="bg-navy-DEFAULT text-white pt-16 pb-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          {/* Brand */}
          <div className="md:col-span-1">
            <div className="font-display text-gold-DEFAULT text-2xl mb-3">ProServ</div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Lawn Care', 'House Cleaning', 'Snow Removal', 'Handyman', 'Window Cleaning', 'Tree Trimming'].map(s => (
                <li key={s}>
                  <Link href="/services" className="text-sm text-white/60 hover:text-gold-DEFAULT transition-colors">
                    {s}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-white/60 hover:text-gold-DEFAULT transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2.5 text-sm text-white/60">
                ...
                <a href="tel:+15551234567" className="hover:text-gold-DEFAULT transition-colors">(555) 123-4567</a>
              </li>
              <li className="flex items-center gap-2.5 text-sm text-white/60">
                <Mail size={14} className="text-gold-DEFAULT flex-shrink-0" />
                <a href="mailto:hello@proserv.com" className="hover:text-gold-DEFAULT transition-colors">hello@proserv.com</a>
              </li>
              <li className="flex items-start gap-2.5 text-sm text-white/60">
                <MapPin size={14} className="text-gold-DEFAULT flex-shrink-0 mt-0.5" />
                New Rome, OH & Surrounding Areas
              </li>
            </ul>
            <div className="mt-4">
              <p className="text-xs text-white/30 mb-1">Hours</p>
              <p className="text-sm text-white/60">Mon – Sat: 7:00 AM – 7:00 PM</p>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/30">
            © {new Date().getFullYear()} ProServ Local Services. All rights reserved.
          </p>
